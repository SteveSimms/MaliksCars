...
namespace MaliksCars.Application.Database.Migrations
{
    ...
    [Migration("20230611031958_AddUserFavoriteCarTable")]
    partial class AddUserFavoriteCarTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaliksCars.Application.Models.Car", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BasePrice = "35000",
                            Color = "Green",
                            CreatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4650),
                            ...
                            Model = "Tacoma",
                            Name = "Toyota",
                            UpdatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4690),
                            Year = "2024"
                        },
                        new
                        {
                            ...
                            BasePrice = "38760",
                            Color = "Blue",
                            CreatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4700),
                            ...
                            Model = "Tundra",
                            Name = "Toyota",
                            UpdatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4700),
                            Year = "2024"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Model = "Prius",
                            Name = "Toyota",
                            UpdatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4710),
                            Year = "2024"
                        },
                        new
                        {
                            ...
                            BasePrice = "26000",
                            Color = "Black",
                            CreatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4710),
                        ...
                        new
                        {
                            ...
                            BasePrice = "29000",
                            Color = "Blue",
                            CreatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4720),
                            ...
                            Model = "Hrv",
                            Name = "Honda",
                            UpdatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4720),
                            Year = "2024"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            BasePrice = "235000",
                            Color = "Orange",
                            CreatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4730),
                            ...
                            Model = "Urus",
                            Name = "Lamborghini",
                            UpdatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4730),
                            Year = "2024"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Model = "Amg G63",
                            Name = "Mercedes",
                            UpdatedAt = new DateTime(2023, 6, 10, 20, 19, 58, 651, DateTimeKind.Local).AddTicks(4740),
                            Year = "2023"
                        });
                });
            ...
            modelBuilder.Entity("MaliksCars.Application.Models.UserFavoriteCar", b =>
                {
                    ...
                    b.HasKey("UserId", "CarId")
                        .HasName("pk_user_favorite_cars");

                    b.HasIndex("CarId")
                        .HasDatabaseName("ix_user_favorite_cars_car_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_favorite_cars_user_id");

                    b.ToTable("user_favorite_cars", (string)null);
                });
            ...
            modelBuilder.Entity("MaliksCars.Application.Models.UserFavoriteCar", b =>
                {
                    b.HasOne("MaliksCars.Application.Models.Car", "Car")
                        .WithMany("UserFavoriteCars")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_favorite_cars_cars_car_id");
                    ...
                    b.HasOne("MaliksCars.Application.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_favorite_cars_users_user_id");
